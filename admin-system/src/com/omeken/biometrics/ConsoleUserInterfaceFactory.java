...
//            } catch (Exception e) { }
         ...
         */
        public void register(String activeReader) {
            System.out.printf("Performing fingerprint enrollment...\n");
            //Home.jTextArea8.setText("Performing fingerprint enrollment...\n");
...
//                        sb.append("    ").append(fingerName(finger)).append("\n");
                ...
                if (fingers.length() > 0) {
                    System.out.println("The following fingers for " +username+" have already been enrolled:"+fingers+" Choose a finger to enroll:");
                } else {
                    System.out.println("No fingers for "+username+ "have been enrolled. Choose a finger to enroll:");
                }
                ...
                int nFinger = 1;//MenuShow(menu, MENU_WITH_BACK);
         ...
         */
        public String selectReader(String activeReader) throws IndexOutOfBoundsException {
            DPFPReadersCollection readers = DPFPGlobal.getReadersFactory().getReaders();
            if (readers == null || readers.size() == 0)
            ...
            return activeReader;
//            System.out.println("This was returned from reader selection menu:"+res);
